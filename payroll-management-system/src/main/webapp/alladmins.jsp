...
<head>
    <meta charset="UTF-8">
    <title>All Admins | Employee Payroll Management System</title>
            ...
            <div class="container clearfix">
                ...
                <div class="main-navigation" id="main-nav-bar">
                    <ul class=" navigation-box">
                        ...
                        <li class=" current">
                            <a href="all-admins">Admins List</a>
                        </li>
                        <li>
            ...
            <c:forEach items="${admins}" var="admin">
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12 masonary-item">
                    <div class="single-service-style-eight hvr-sweep-to-bottom">
                        <div class="img-box">
                            <img src="images/admin.jpg" alt="Awesome Image">
                        </div><!-- /.img-box -->
                        <div class="text-block">
                            <h3><a href="#"></a></h3>
                            <p>${admin.email}</p><br>
                            <p>Password: ${admin.password}</p>
                            <a href="/delete-admin?id=${admin.id }" onclick= 'myFunction()' class="read-more">Delete</a>
                        </div><!-- /.text-block -->
